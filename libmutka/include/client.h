...
struct mutka_client {
    ...
    // Client will generate its own local metadata keypair.
    // Server will generate another keypair for the client (stored in server memory).
    ...
    char expected_captcha_answer [MUTKA_CAPTCHA_MAX];
